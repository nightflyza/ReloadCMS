...
show_window(__('Search'), '<center><table><tr><td align="left"><form method=GET>
    <input type="hidden" name="module" value="search.result">
    <input type=text name="search" size='.$config['width'].' value="'.$init.'">&nbsp;<input type=submit value="'.__('Find').'"></td></tr>'.$chose.'</form></table></center>');
?>